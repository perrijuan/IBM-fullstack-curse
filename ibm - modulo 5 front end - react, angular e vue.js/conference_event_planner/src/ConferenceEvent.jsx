    ...
    return (
        <>
            <navbar className="navbar_event_conference">
                <div className="company_logo">Planejador de Despesas da Conferência</div>
                <div className="left_navbar">
                    <div className="nav_links">
                        <a href="#venue" onClick={() => navigateToProducts("#venue")} >Local</a>
                        <a href="#addons" onClick={() => navigateToProducts('#addons')}>Complementos</a>
                        <a href="#meals" onClick={() => navigateToProducts('#meals')}>Refeições</a>
                    </div>
        ...
        <div className="text">
          ...
          <h1>Seleção da Sala do Local</h1>
        </div>
     ...
     <div className="button_container">
        ...
        <div className="total_cost">Custo Total: ${venueTotalCost}</div>
      </div>
                            {/*Complementos Necessários*/}
                            <div id="addons" className="venue_container container_main">
                                <div className="text">
                                    <h1>Seleção de Complementos</h1>
                                </div>
...
<div className="total_cost">Custo Total: {avTotalCost}</div>
                            </div>
                            {/* Seção de Refeições */}
                            <div id="meals" className="venue_container container_main">
                                <div className="text">
                                    <h1>Seleção de Refeições</h1>
                                </div>
